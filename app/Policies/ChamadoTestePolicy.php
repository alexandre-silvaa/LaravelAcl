...
class ChamadoTestePolicy
{
    ...
    {
        if($user->eAdmin()){
            return true; //pode fazer tudo no sistema, as regras não se aplicam a este usuário
        }
    }
    ...
    {
        return $user->id == $chamado->user_id; //quem está relacionado ao chamado que pode ver, atualizar ou deletar
    }
